...
export const esperiences: Experience[] = [
    {role: "Software Developer", company:"Cineca Consortium - Italy",description:"Traduct functional and non functional requirements into technical requirements of software product that meet the customer needs. Design and realize Website, API REST and SOAP. Organize functional and unit tests. Design and optimize Database. Write technical documentation", date:"06/2014 - present"},
